  ...
  return (
    <div>
      <section>
        ...
        <div
          className="productBanner hidden px-5 bg-[#3a3a3a] py-10 text-white w-full sm:flex items-center sm:px-20 lg:px-36"
          style={{
            backgroundImage: "url('/assets/producthero.png')",
